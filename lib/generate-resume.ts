import { Document, Paragraph,Packer, TextRun, HeadingLevel, AlignmentType, Table, TableRow, TableCell, BorderStyle } from 'docx';
    ...
    sections: [{
      ...
      children: [
        ...
        ...data.experience.map(job => [
          ...
          new Paragraph({
            children: [
              new TextRun({ text: `${job.location} | ${job.period}`, italics: true }),
            ],
          }),
