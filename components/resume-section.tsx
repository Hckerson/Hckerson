			...
			<div className="container max-w-5xl">
				...
				>
					...
					<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
						My professional journey and experience in the tech
						industry.
					</p>
					<div className="mt-6">
						<Button
									...
									<Card>
										<CardContent className="pt-6">
											...
											<p className="mt-3 text-sm">
												"Still grinding. Focused on web
												development, algorithms, and
												database systems. trying to
												break into the web3 space"
											</p>
										</CardContent>
									</Card>
								</div>
